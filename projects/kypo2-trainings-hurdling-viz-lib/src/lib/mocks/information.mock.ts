export const GAME_INFORMATION = {
	...
	authors: [
		{
			...
			user_ref_id: 40,
			login: '123456@mail.com',
			full_name: 'RNDr. John Doe',
			given_name: 'John',
			family_name: 'Doe',
		},
	],
	...
	levels: [
		...
		},
		{
			...
			solution:
				'<a href="https://www.google.com/search?hl=&site=&q=libssh+vulnerability&gws_rd=ssl">Google "libssh vulnerability"</a><br>\nCVE-2018-10933\n',
			...
			hints: [
				...
				},
				{
					...
					content:
						'Try googling the name of the ssh server and use keyword "vulnerability"',
					hint_penalty: 1,
				},
			],
			...
			hints: [
				{
					...
					content:
						"You might have to have *some* password. Don't forget about character escaping. In what format does Linux store passwords?",
					hint_penalty: 3,
				},
				{
					id: 39,
