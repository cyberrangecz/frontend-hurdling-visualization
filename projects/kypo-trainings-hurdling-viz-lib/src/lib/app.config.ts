...
export class AppConfig {
  ...
  eventProps: {
    ...
    eventShapes: GenericObject;
  };
  shapes: GenericObject;
...
export const CTF_PROGRESS_CONFIG: AppConfig = {
  ...
  eventProps: {
    ...
    eventShapes: {
      ...
      group:
        "M17.5,9c0,4.7-3.8,8.5-8.5,8.5c-4.7,0-8.5-3.8-8.5-8.5c0-4.7,3.8-8.5,8.5-8.5C13.7,0.5,17.5,4.3,17.5,9z",
      wrong:
  ...
  shapes: {
    ...
    remove:
      "M19,3 H5C3.9,3 3,3.9 3,5v14c0,1.1 0.9,2 2,2h14c1.1,0 2,-0.9 2,-2V5C21,3.9 20.1,3 19,3ZM17,13H7v-2h10z",
  },
